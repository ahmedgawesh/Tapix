...
class BarcodeTemplates extends Table {
  ...
  BoolColumn get includeCompanyName => boolean().withDefault(const Constant(false))();
  /// Whether to show size/color variant info
  BoolColumn get includeVariantInfo => boolean().withDefault(const Constant(false))();
...
class PrintHistories extends Table {
  ...
  IntColumn get templateId => integer().nullable().references(BarcodeTemplates, #id, onDelete: KeyAction.setNull)();
