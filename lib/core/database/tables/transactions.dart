...
class SaleItems extends Table {
  ...
  IntColumn get qtyReturnedAdjustment => integer().withDefault(const Constant(0))();
  DateTimeColumn get createdAt => dateTime().withDefault(currentDateAndTime)();
}
...
class SaleReturns extends Table {
  ...
  IntColumn get reasonCodeId => integer()
      .nullable()
      .references(ReturnReasonCodes, #id, onDelete: KeyAction.setNull)();
...
class SaleReturnItems extends Table {
  ...
  /// and return.
  IntColumn get unitCostAtPostCents => integer().nullable().map(const MoneyConverter())();
  DateTimeColumn get createdAt => dateTime().withDefault(currentDateAndTime)();
}
...
class PurchaseReturnAdjustmentItems extends Table {
  IntColumn get id => integer().autoIncrement()();
  IntColumn get returnId => integer().references(PurchaseReturnAdjustments, #id, onDelete: KeyAction.cascade)();
  IntColumn get productId => integer().references(Products, #id, onDelete: KeyAction.restrict)();
  IntColumn get variantId => integer().nullable().references(ProductVariants, #id, onDelete: KeyAction.restrict)();
  IntColumn get quantity => integer()();
  IntColumn get unitPriceCents => integer().map(const MoneyConverter())();
  ...
  IntColumn get unitCostCents => integer().map(const MoneyConverter()).withDefault(const Constant(0))();
  IntColumn get discountCents => integer().map(const MoneyConverter()).withDefault(const Constant(0))();
  IntColumn get taxCents => integer().map(const MoneyConverter()).withDefault(const Constant(0))();
  IntColumn get totalCents => integer().map(const MoneyConverter())();
  TextColumn get reason => text().nullable()();
...
class SaleReturnAdjustmentItems extends Table {
  IntColumn get id => integer().autoIncrement()();
  IntColumn get returnId => integer().references(SaleReturnAdjustments, #id, onDelete: KeyAction.cascade)();
  IntColumn get productId => integer().references(Products, #id, onDelete: KeyAction.restrict)();
  IntColumn get variantId => integer().nullable().references(ProductVariants, #id, onDelete: KeyAction.restrict)();
  IntColumn get quantity => integer()();
  IntColumn get unitPriceCents => integer().map(const MoneyConverter())();
