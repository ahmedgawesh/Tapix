...
/// schema. The ledger is intentionally polymorphic: [operation] identifies the
/// document table while [documentId] identifies the completed document.
    ...
    CREATE TABLE IF NOT EXISTS lan_request_receipts (
      ...
      CHECK (
        ...
        (state = 'legacy' AND request_hash IS NULL
          AND document_id IS NOT NULL AND completed_at IS NOT NULL)
      )
    )
  ''');
  await db.customStatement('''
