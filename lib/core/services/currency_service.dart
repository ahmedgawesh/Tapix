...
class Currency {
  ...
  static const List<Currency> supportedCurrencies = [
    ...
    Currency(code: 'SEK', symbol: 'kr', name: 'Swedish Krona', symbolPosition: SymbolPosition.after),
    Currency(code: 'NOK', symbol: 'kr', name: 'Norwegian Krone', symbolPosition: SymbolPosition.after),
    Currency(code: 'DKK', symbol: 'kr', name: 'Danish Krone', symbolPosition: SymbolPosition.after),
    Currency(code: 'KRW', symbol: '₩', name: 'South Korean Won', decimalDigits: 0),
    Currency(code: 'INR', symbol: '₹', name: 'Indian Rupee'),
    Currency(code: 'RUB', symbol: '₽', name: 'Russian Ruble', symbolPosition: SymbolPosition.after),
    ...
    Currency(code: 'PLN', symbol: 'zł', name: 'Polish Zloty', symbolPosition: SymbolPosition.after),
    Currency(code: 'THB', symbol: '฿', name: 'Thai Baht'),
    Currency(code: 'IDR', symbol: 'Rp', name: 'Indonesian Rupiah', decimalDigits: 0),
    ...
    Currency(code: 'CZK', symbol: 'Kč', name: 'Czech Koruna', symbolPosition: SymbolPosition.after),
    Currency(code: 'HUF', symbol: 'Ft', name: 'Hungarian Forint', decimalDigits: 0),
    Currency(code: 'ILS', symbol: '₪', name: 'Israeli Shekel'),
    Currency(code: 'CLP', symbol: 'CL\$', name: 'Chilean Peso', decimalDigits: 0),
    Currency(code: 'COP', symbol: 'COL\$', name: 'Colombian Peso', decimalDigits: 0),
    ...
    Currency(code: 'RON', symbol: 'lei', name: 'Romanian Leu', symbolPosition: SymbolPosition.after),
    ...
    Currency(code: 'QAR', symbol: 'ر.ق', name: 'Qatari Riyal', symbolPosition: SymbolPosition.after),
    Currency(code: 'KWD', symbol: 'د.ك', name: 'Kuwaiti Dinar', decimalDigits: 3, symbolPosition: SymbolPosition.after),
    Currency(code: 'BHD', symbol: 'د.ب', name: 'Bahraini Dinar', decimalDigits: 3, symbolPosition: SymbolPosition.after),
    Currency(code: 'OMR', symbol: 'ر.ع', name: 'Omani Rial', decimalDigits: 3, symbolPosition: SymbolPosition.after),
    Currency(code: 'JOD', symbol: 'د.ا', name: 'Jordanian Dinar', decimalDigits: 3, symbolPosition: SymbolPosition.after),
    Currency(code: 'IQD', symbol: 'ع.د', name: 'Iraqi Dinar', decimalDigits: 0, symbolPosition: SymbolPosition.after),
    Currency(code: 'LBP', symbol: 'ل.ل', name: 'Lebanese Pound', decimalDigits: 0, symbolPosition: SymbolPosition.after),
    Currency(code: 'MAD', symbol: 'د.م', name: 'Moroccan Dirham', symbolPosition: SymbolPosition.after),
    Currency(code: 'TND', symbol: 'د.ت', name: 'Tunisian Dinar', decimalDigits: 3, symbolPosition: SymbolPosition.after),
    Currency(code: 'DZD', symbol: 'د.ج', name: 'Algerian Dinar', symbolPosition: SymbolPosition.after),
    Currency(code: 'LYD', symbol: 'ل.د', name: 'Libyan Dinar', decimalDigits: 3, symbolPosition: SymbolPosition.after),
    Currency(code: 'SDG', symbol: 'ج.س', name: 'Sudanese Pound', symbolPosition: SymbolPosition.after),
    Currency(code: 'YER', symbol: 'ر.ي', name: 'Yemeni Rial', symbolPosition: SymbolPosition.after),
    Currency(code: 'SYP', symbol: 'ل.س', name: 'Syrian Pound', symbolPosition: SymbolPosition.after),
  ];

  static List<Currency> _customCurrencies = [];

  static List<Currency> get allCurrencies => [...supportedCurrencies, ..._customCurrencies];
  ...
  Map<String, dynamic> toJson() => {
    ...
    'symbol': symbol,
    'name': name,
    'symbolPosition': symbolPosition == SymbolPosition.after ? 'after' : 'before',
  ...
  factory Currency.fromJson(Map<String, dynamic> json) => Currency(
    ...
    symbolPosition: json['symbolPosition'] == 'after' ? SymbolPosition.after : SymbolPosition.before,
...
class CurrencyService {
  ...
  List<Currency> get customCurrencies => List.unmodifiable(Currency._customCurrencies);
