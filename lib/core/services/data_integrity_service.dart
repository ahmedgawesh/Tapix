...
class DataIntegrityService {
  ...
  Future<List<({int variantId, int productId, int stockQuantity})>> findNegativeStockVariants() async {
    final rows = await _db.customSelect(
...
class IntegrityReport {
  ...
  final List<({int variantId, int productId, int stockQuantity})> negativeStockVariants;
