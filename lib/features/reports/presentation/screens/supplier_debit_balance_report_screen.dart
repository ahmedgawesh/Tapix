...
class _SupplierDebitBalanceReportView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          BlocBuilder<
            SupplierDebitBalanceReportBloc,
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: DateRangeSelector(
                        ...
                        onChanged: (range) =>
                            context.read<SupplierDebitBalanceReportBloc>().add(
                              SupplierDebitBalanceReportDateRangeChanged(range),
                            ),
                      ),
                    ),
  ...
  Widget _buildSummaryCards(
    ...
    SupplierDebitBalanceReportData data,
  ) {
    final theme = Theme.of(context);
    final colorScheme = theme.colorScheme;
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              'reports.no_supplier_debit_balances'.tr(),
              style: theme.textTheme.bodyLarge,
            ),
            const SizedBox(height: 8),
            Text(
              'reports.no_supplier_debit_balances_desc'.tr(),
              style: theme.textTheme.bodySmall?.copyWith(
                color: theme.colorScheme.onSurfaceVariant,
              ),
            ),
...
class _SupplierDebitBalanceCard extends StatelessWidget {
  ...
  const _SupplierDebitBalanceCard({required this.item, required this.cs});
