...
class ProductMovementPdfService {
  static Future<void> printReport({
    ...
    await Printing.layoutPdf(
      ...
      name: 'ProductMovement_${data.selectedProductName ?? ""}_ ${DateFormat('yyyyMMdd').format(DateTime.now())}',
    );
  }
  ...
  static Future<void> shareReport({
    ...
    await Printing.sharePdf(
      bytes: bytes,
      filename: 'ProductMovement_${data.selectedProductName ?? ""}_${DateFormat('yyyyMMdd').format(DateTime.now())}.pdf',
    );
  }
  ...
  static pw.Widget _buildSummaryTable(
    ...
    return pw.TableHelper.fromTextArray(
      ...
      data: [
        ...
        [_t('sale_returns', lang), '+${summary.totalSaleReturned}', cs.formatCents(summary.totalSaleReturnCents)],
        [_t('purchase_returns', lang), '-${summary.totalPurchaseReturned}', cs.formatCents(summary.totalPurchaseReturnCents)],
        [
  ...
  static const _translations = {
    'title': {'en': 'Product Movement Report', 'ar': 'تقرير حركة المنتج', 'fr': 'Rapport de Mouvement Produit'},
