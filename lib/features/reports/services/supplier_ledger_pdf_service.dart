...
import '../presentation/bloc/supplier_ledger_report_bloc.dart';

class SupplierLedgerPdfService {
  static Future<void> printLedger({
    required BuildContext context,
    required SupplierLedgerData data,
  }) async {
    ...
    await Printing.layoutPdf(
      ...
      name:
          'SupplierLedger_${data.supplierName ?? ''}_${DateFormat('yyyyMMdd').format(DateTime.now())}',
    );
  }
  ...
  static Future<void> shareLedger({
    ...
    await Printing.sharePdf(
      ...
      filename:
          'SupplierLedger_${data.supplierName ?? ''}_${DateFormat('yyyyMMdd').format(DateTime.now())}.pdf',
    );
  }
  ...
  static Future<pw.Document> _buildPdf({
    ...
    final headers = [
      ...
      _t('purchase_qty', lang),
      _t('purchase_total', lang),
              ...
              ...rows.asMap().entries.map((entry) {
                ...
                return pw.TableRow(
                  ...
                  children: cells.asMap().entries.map((cellEntry) {
                    ...
                    } else if (isPurchaseAmt && cellText != '-') {
  ...
  static const _translations = <String, Map<String, String>>{
    'title': {
      'en': 'Supplier Ledger Account Statement',
