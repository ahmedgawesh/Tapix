...
class SupplierStatementPdfService {
  static Future<void> printSupplierStatement({
    ...
    required SupplierStatementData data,
  }) async {
    ...
    await Printing.layoutPdf(
      ...
      name:
          'SupplierStatement_${data.supplierName ?? ''}_${DateFormat('yyyyMMdd').format(DateTime.now())}',
    );
  }

  static Future<void> shareSupplierStatement({
    required BuildContext context,
    required SupplierStatementData data,
  }) async {
    final cs = sl<CurrencyService>();
    ...
    await Printing.sharePdf(
      bytes: bytes,
      filename:
          'SupplierStatement_${data.supplierName ?? ''}_${DateFormat('yyyyMMdd').format(DateTime.now())}.pdf',
    );
  }
