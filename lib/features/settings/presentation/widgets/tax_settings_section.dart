        ...
        return SettingsExpansionCard(
          ...
          children: [
            SwitchListTile(
              ...
              onChanged: (v) =>
                  _patch(context, (c) => c.copyWith(enableTaxCalculations: v)),
            ),
            SettingsSliderTile(
              ...
              labelSuffix: '%',
              onChanged: (v) =>
                  _patch(context, (c) => c.copyWith(defaultPurchaseTaxRate: v)),
            ),
            SettingsSliderTile(
              ...
              labelSuffix: '%',
              onChanged: (v) =>
                  _patch(context, (c) => c.copyWith(defaultSalesTaxRate: v)),
            ),
            SettingsTextField(
              ...
              onChanged: (v) =>
                  _patch(context, (c) => c.copyWith(taxRegistrationNumber: v)),
            ),
            ...
            SwitchListTile(
              ...
              onChanged: (v) =>
                  _patch(context, (c) => c.copyWith(taxInclusivePricing: v)),
            ),
          ],
        );
      },
