...
import '../widgets/consignment_settings_section.dart';
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            _buildSectionCard(
              ...
              child: BlocBuilder<CurrencyBloc, RealtimeState<Currency>>(
                builder: (context, state) {
                  ...
                  final formattedPreview = context
                      .read<CurrencyService>()
                      .format(previewAmount);

                  final translatedName = 'currency.${currentCurrency.code}'
                      .tr();
                  final displayName =
            ...
            const SizedBox(height: 8),
            const ConsignmentSettingsSection(),
            const SizedBox(height: 8),
