...
class CustomerTransactionPdfService {
  ...
  static Future<pw.Document> _buildReceipt({
    ...
    if (isReturnChequeSettlement) {
      title = 'customers.return_cheque_settlement_receipt'.tr();
  ...
  static String _localizedTransactionType(CustomerTransaction transaction) {
    ...
    if (type == 'payment' &&
      ...
      return 'cheques.direction_incoming'.tr();
    }
    switch (type) {
      case 'payment':
  ...
  static pw.Widget _buildCustomerInfo({
    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          _bidiText(
            'customers.customer_info_label'.tr(),
            fonts.bold,
            fontSize: 11,
          ...
          if (customerPhone != null && customerPhone.isNotEmpty)
            _pdfInfoRow(
              'customers.phone_label'.tr(),
              customerPhone,
              fonts.regular,
            ),
          if (customerAddress != null && customerAddress.isNotEmpty)
            _pdfInfoRow(
              'customers.address_label'.tr(),
              customerAddress,
              fonts.regular,
            ),
        ],
        ...
        children: [
          pw.Column(
            children: [
              ...
              _bidiText(
                'customers.company_signature'.tr(),
                fonts.regular,
                fontSize: 9,
                color: PdfColors.grey600,
              ),
          ...
          pw.Column(
            children: [
              ...
              pw.SizedBox(height: 4),
              _bidiText(
                'customers.customer_signature'.tr(),
                fonts.regular,
                fontSize: 9,
                color: PdfColors.grey600,
              ),
