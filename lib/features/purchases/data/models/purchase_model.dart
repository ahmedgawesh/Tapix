...
class PurchaseItemModel extends PurchaseItemEntity {
  PurchaseItemModel({
    ...
    super.productName,
    super.variantSku,
    super.supplierIdentityRequested,
    super.supplierIdentityId,
    super.supplierSourceSku,
    super.colorName,
    super.colorHex,
    super.sizeName,
  ...
  factory PurchaseItemModel.fromDriftWithDetails(PurchaseItemWithDetails d) {
    return PurchaseItemModel(
      ...
      supplierIdentityRequested: d.item.supplierIdentityRequested,
      supplierIdentityId: d.item.supplierIdentityId,
      supplierSourceSku: d.supplierIdentity?.sourceSku,
