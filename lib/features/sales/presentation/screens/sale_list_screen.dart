...
class _SaleHubViewState extends State<_SaleHubView> {
  ...
  Widget _buildErrorState(
    ...
    RealtimeError<SalesHubData> state,
  ) {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
                ...
                children: [
                  ...
                  _FilterChip(
                    ...
                    onSelected: () {
                      ...
                      context.read<SalesBloc>().add(
                        const SalesStatusFilterChanged(null),
                      );
                    },
                  ),
                  ...
                  _FilterChip(
                    ...
                    onSelected: () {
                      ...
                      context.read<SalesBloc>().add(
                        const SalesStatusFilterChanged('completed'),
                      );
                    },
                  ),
                  const SizedBox(width: 4),
                  _FilterChip(
                    ...
                    onSelected: () {
                      ...
                      context.read<SalesBloc>().add(
                        const SalesStatusFilterChanged('voided'),
                      );
                    },
                  ),
                ],
