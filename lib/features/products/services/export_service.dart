...
class ExportServiceImpl implements ExportService {
  ...
  Future<String> exportToCSV({
    ...
    return _stockReader.snapshot(() async {
      ...
      try {
        ...
        for (final product in filteredProducts) {
          ...
          if (!product.hasVariants) {
            ...
            final storedDefault = await _variantRepository
                .getDefaultVariantByProduct(product.id);
            final defaultVariant =
                storedDefault != null && storedDefault.isActive
                ? await _stockReader.read(storedDefault)
                : null;
            ...
            for (final storedVariant in variants) {
              final v = await _stockReader.read(storedVariant);
