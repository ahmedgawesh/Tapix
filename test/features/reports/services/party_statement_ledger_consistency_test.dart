...
void main() {
  ...
  test(
    ...
    () async {
      ...
      final customerCashRefund = customerSnapshot.transactions.singleWhere(
      ...
      final supplierCashRefund = supplierSnapshot.transactions.singleWhere(
        (transaction) => transaction.type == 'refund',
      );
      ...
      expect(
        customerStatementState.data.transactions
            .singleWhere((transaction) => transaction.type == 'refund')
            .isDisplayOnly,
        isTrue,
      );
      ...
      expect(
        supplierStatementState.data.transactions
            .singleWhere((transaction) => transaction.type == 'refund')
            .isDisplayOnly,
        isTrue,
      );
