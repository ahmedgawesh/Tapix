  ...
  group('UserFormBloc', () {
    ...
    group('UserFormSubmitRequested - Create', () {
      blocTest<UserFormBloc, UserFormState>(
        ...
        build: () => UserFormBloc(mockRepository),
        act: (bloc) => bloc.add(const UserFormSubmitRequested(
          username: '',
        ...
        expect: () => [
          ...
          isA<UserFormError>()
              .having((s) => s.message, 'message', 'username_required'),
        ],
      );
      ...
      blocTest<UserFormBloc, UserFormState>(
        ...
        expect: () => [
          isA<UserFormSubmitting>(),
          isA<UserFormError>()
              .having((s) => s.message, 'message', 'username_min_length'),
        ],
      );
      ...
      blocTest<UserFormBloc, UserFormState>(
        ...
        setUp: () {
          when(() => mockRepository.isUsernameTaken('taken', excludeUserId: null))
        ...
        expect: () => [
          isA<UserFormSubmitting>(),
          isA<UserFormError>()
              .having((s) => s.message, 'message', 'username_taken'),
        ],
      );
      ...
      blocTest<UserFormBloc, UserFormState>(
        ...
        setUp: () {
          when(() => mockRepository.isUsernameTaken('newuser', excludeUserId: null))
        ...
        expect: () => [
          isA<UserFormSubmitting>(),
          isA<UserFormError>()
              .having((s) => s.message, 'message', 'password_required'),
        ],
      );
      ...
      blocTest<UserFormBloc, UserFormState>(
        ...
        expect: () => [
          isA<UserFormSubmitting>(),
          isA<UserFormError>()
              .having((s) => s.message, 'message', 'password_min_length'),
        ],
      );
      ...
      blocTest<UserFormBloc, UserFormState>(
        ...
        expect: () => [
          isA<UserFormSubmitting>(),
          isA<UserFormError>()
              .having((s) => s.message, 'message', 'passwords_not_match'),
        ],
      );
      ...
      blocTest<UserFormBloc, UserFormState>(
        ...
        expect: () => [
          isA<UserFormSubmitting>(),
          isA<UserFormSuccess>()
              .having((s) => s.message, 'message', 'created_success'),
        ],
      );
    });
    ...
    group('UserFormSubmitRequested - Update', () {
      blocTest<UserFormBloc, UserFormState>(
        ...
        setUp: () {
          when(() => mockRepository.isUsernameTaken('updated', excludeUserId: 1))
              .thenAnswer((_) async => false);
        ...
        expect: () => [
          isA<UserFormSubmitting>(),
          isA<UserFormSuccess>()
              .having((s) => s.message, 'message', 'updated_success'),
        ],
      );
