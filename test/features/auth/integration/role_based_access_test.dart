...
void main() {
  ...
  group('Task 3.2: Financial Operations (Manager+ only)', () {
    test('Owner has financial operation permissions', () {
      final owner = createUser(UserRole.owner);
      expect(
        permissionService.hasPermission(owner, Permissions.viewReports),
        isTrue,
      );
      expect(
        permissionService.hasPermission(owner, Permissions.manageExpenses),
        isTrue,
      );
      expect(
      ...
      expect(
        permissionService.hasPermission(owner, Permissions.manageAccounting),
        isTrue,
      );
    });
    ...
    test('Manager has financial operation permissions', () {
      ...
      expect(
        permissionService.hasPermission(manager, Permissions.exportData),
        isTrue,
      );
    });
    ...
    test('Cashier lacks financial operation permissions', () {
      final cashier = createUser(UserRole.cashier);
      expect(
        permissionService.hasPermission(cashier, Permissions.viewReports),
        isFalse,
      );
      expect(
      ...
      expect(
        permissionService.hasPermission(cashier, Permissions.manageTaxes),
        isFalse,
      );
    });
    ...
    test('Salesperson lacks financial operation permissions', () {
      final salesperson = createUser(UserRole.salesperson);
      expect(
        permissionService.hasPermission(salesperson, Permissions.viewReports),
        isFalse,
      );
      expect(
  ...
  group('Task 3.3: Stock Modification (Manager+ only)', () {
    test('Owner can modify stock', () {
      final owner = createUser(UserRole.owner);
      expect(
        permissionService.hasPermission(owner, Permissions.adjustStock),
        isTrue,
      );
      expect(
        permissionService.hasPermission(owner, Permissions.editProducts),
        isTrue,
      );
      expect(
        permissionService.hasPermission(owner, Permissions.deleteProducts),
        isTrue,
      );
    });
    ...
    test('Manager can modify stock', () {
      final manager = createUser(UserRole.manager);
      expect(
        permissionService.hasPermission(manager, Permissions.adjustStock),
        isTrue,
      );
      expect(
      ...
      expect(
        permissionService.hasPermission(manager, Permissions.deleteProducts),
        isTrue,
      );
    });
    ...
    test('Cashier cannot modify stock', () {
      final cashier = createUser(UserRole.cashier);
      expect(
        permissionService.hasPermission(cashier, Permissions.adjustStock),
        isFalse,
      );
      expect(
      ...
      expect(
        permissionService.hasPermission(cashier, Permissions.deleteProducts),
        isFalse,
      );
    });
    ...
    test('Salesperson cannot modify stock', () {
      final salesperson = createUser(UserRole.salesperson);
      expect(
        permissionService.hasPermission(salesperson, Permissions.adjustStock),
        isFalse,
      );
      expect(
        permissionService.hasPermission(salesperson, Permissions.editProducts),
        isFalse,
      );
    });
  ...
  group('Task 3.4: Basic Sales Operations (All roles)', () {
    test('Owner can process sales', () {
      final owner = createUser(UserRole.owner);
      expect(
        permissionService.hasPermission(owner, Permissions.processSales),
        isTrue,
      );
      expect(
        permissionService.hasPermission(owner, Permissions.createSales),
        isTrue,
      );
    });
    ...
    test('Manager can process sales', () {
      final manager = createUser(UserRole.manager);
      expect(
        permissionService.hasPermission(manager, Permissions.processSales),
        isTrue,
      );
      expect(
        permissionService.hasPermission(manager, Permissions.createSales),
        isTrue,
      );
    });
    ...
    test('Cashier can process sales', () {
      ...
      expect(
        permissionService.hasPermission(cashier, Permissions.createSales),
        isTrue,
      );
      expect(
    ...
    test('Salesperson can create sales', () {
      final salesperson = createUser(UserRole.salesperson);
      expect(
        permissionService.hasPermission(salesperson, Permissions.processSales),
        isTrue,
      );
      expect(
        permissionService.hasPermission(salesperson, Permissions.createSales),
        isTrue,
      );
      expect(
        permissionService.hasPermission(
  ...
  group('Task 3.5: User Management (Owner only)', () {
    test('Owner has user management permissions', () {
      ...
      expect(
        permissionService.hasPermission(owner, Permissions.deactivateUsers),
        isTrue,
      );
    });
    ...
    test('Manager lacks user management permissions', () {
      ...
      expect(
        permissionService.hasPermission(manager, Permissions.deactivateUsers),
        isFalse,
      );
    });
    ...
    test('Cashier lacks user management permissions', () {
      final cashier = createUser(UserRole.cashier);
      expect(
        permissionService.hasPermission(cashier, Permissions.manageUsers),
        isFalse,
      );
    });
    ...
    test('Salesperson lacks user management permissions', () {
      final salesperson = createUser(UserRole.salesperson);
      expect(
        permissionService.hasPermission(salesperson, Permissions.manageUsers),
        isFalse,
      );
    });
  ...
  group('Route-based Access Control', () {
    test('Route permissions match role hierarchy', () {
      ...
      expect(
        permissionService.canAccessRoute(salesperson, '/settings'),
        isFalse,
      );
      ...
      expect(
        permissionService.canAccessRoute(salesperson, '/reports'),
        isFalse,
      );
  ...
  group('Inactive User Access Control', () {
    test('Inactive user has no permissions regardless of role', () {
      ...
      expect(
        permissionService.hasPermission(inactiveOwner, Permissions.manageUsers),
        isFalse,
      );
      expect(
        permissionService.hasPermission(
      ...
      expect(
        permissionService.canAccessRoute(inactiveOwner, '/sales'),
        isFalse,
      );
      expect(
