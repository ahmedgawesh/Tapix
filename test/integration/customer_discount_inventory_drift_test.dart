  ...
  test(
    ...
    () async {
      ...
      final entries = await (db.select(
        db.journalEntries,
      )..where((e) => e.entryType.equals('customer_discount'))).get();
      ...
      expect(
        ...
        equals({'5500', '1100'}),
        reason:
            'JE must touch exactly Discounts Given (5500) and AR (1100) '
  ...
  test(
    ...
    () async {
      ...
      expect(
        ...
        equals(glPre),
        reason:
            'GL Inventory must NOT move when a customer discount is '
